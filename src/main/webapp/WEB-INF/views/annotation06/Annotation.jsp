		...
		<fieldset>
			...
			<fieldset>
				...
				<form method="get"	action='<c:url value="/Annotation/RequestMappingOne.do"/>'>
					아이디 <input type="text" name="user" /> 비번 
			...
			<fieldset>
     		...
     		예]
			  ...
			  public String 메소드(@RequestParam 자료형 매개변수){
				...
				<form action='<c:url value="/Annotaion/Annotation/RequestParamDiff.do"/>'>
				...
				<form action='<c:url value="/Annotation/RequestParamMap.do"/>'>
					...
					나이 <input type="text"	name="age" /> 
					관심사항: <input type="checkbox" name="inters" value="정치" />정치 
			...
			<fieldset>
				...
				<h4>
					<a href="<c:url value="/Annotation/RequestBody.do"/>">@RequestBody</a>
				</h4>
				<h4>
